    ...
    <main className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-foreground/60">Acesse sua conta para gerenciar seus veículos</p>
        </div>
        ...
        <div className="bg-card/50 backdrop-blur-xl border border-border p-8 rounded-3xl premium-shadow">
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center ml-1">
                <label className="text-sm font-semibold text-foreground/70">Senha</label>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-background px-4 text-foreground/40 font-bold">Ou continue com</span>
            </div>
          </div>

          <div className="flex flex-col gap-4">
            <Button variant="outline" className="w-full py-3 h-auto" onClick={handleGoogleLogin}>
        ...
        <p className="text-center mt-8 text-foreground/60">
          Não tem uma conta? <Link href="/register" className="text-primary font-bold hover:underline">Cadastre-se</Link>
        </p>
      </motion.div>
    </main>
  );
